 ...
 * Passed as a class object later in Retrofit builder method
 * This class defines which kind of REST method would be used
 */
...
public interface RxRestService {
    ...
    //if missing streaming, the file may use up all memory, asynchronized to download file
    @Streaming
    @GET
